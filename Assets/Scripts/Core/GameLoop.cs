...
namespace LABANAN
{
    public class GameLoop : MonoBehaviour
    {
        ...
        private void SetupPlatforms()
        {
            ...
            CreatePlatformVisual("PlatformVisuals", new Vector3(9f, -0.25f, 5), 12f, 1.5f, platTex, new Color(0.3f, 0.35f, 0.3f));
            CreatePlatformVisual("LeftPlatformVisual", new Vector3(3f, 2.75f, 5), 3f, 1.5f, platTex, new Color(0.35f, 0.3f, 0.3f));
            CreatePlatformVisual("RightPlatformVisual", new Vector3(15f, 2.75f, 5), 3f, 1.5f, platTex, new Color(0.3f, 0.3f, 0.35f));

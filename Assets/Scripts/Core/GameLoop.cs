...
namespace LABANAN
{
    public class GameLoop : MonoBehaviour
    {
        ...
        private void SetupPlatforms()
        {
            ...
            CreatePlatformVisual("PlatformVisuals", new Vector3(9f, 1f, 5), 26f, 3f, platTex, new Color(0.3f, 0.35f, 0.3f));
            CreatePlatformVisual("LeftPlatformVisual", new Vector3(2.8f, 4f, 5), 8.6f, 2f, platTex, new Color(0.35f, 0.3f, 0.3f));
            CreatePlatformVisual("RightPlatformVisual", new Vector3(14.8f, 4f, 5), 8.6f, 2f, platTex, new Color(0.3f, 0.3f, 0.35f));

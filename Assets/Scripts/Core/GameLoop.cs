...
namespace LABANAN
{
    public class GameLoop : MonoBehaviour
    {
        ...
        private void SetupPlatforms()
        {
            ...
            CreatePlatformVisual("PlatformVisuals", new Vector3(9f, 0.85f, 5), 25f, 3f, platTex, new Color(0.3f, 0.35f, 0.3f));
            CreatePlatformVisual("LeftPlatformVisual", new Vector3(3f, 3.5f, 5), 5.2f, 2f, platTex, new Color(0.35f, 0.3f, 0.3f));
            CreatePlatformVisual("RightPlatformVisual", new Vector3(15f, 3.5f, 5), 5.2f, 2f, platTex, new Color(0.3f, 0.3f, 0.35f));
